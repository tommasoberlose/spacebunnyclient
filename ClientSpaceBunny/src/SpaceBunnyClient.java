...
public class SpaceBunnyClient {
    ...
    public void connect(String protocol) {
        try {
            ...
            try {
                ...
                factory.setPort(findProtocol(protocol).getSsl_port());
    ...
    public void publish(String channel_name, String msg) {
        ...
        try {
            ...
            channel.queueDeclare(findChannelID(channel_name).getId(), false, false, false, null);
            int i = 0;
            while (i < 20) {
                channel.basicPublish("", findChannelID(channel_name).getId(), null, msg.getBytes());
                System.out.print("|");
                i++;
                Thread.sleep(1000);
            }
